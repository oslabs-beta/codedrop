...
const httpLink = new HttpLink({
  // set the URI
  uri: 'https://dawn-mountain.us-west-2.aws.cloud.dgraph.io/graphql', //process.env.GQL_URI,
});
...
const authLink = setContext((_, { headers }) => {
  ...
  return {
    headers: {
      ...headers,
      'Dg-Auth': 'MGRiNDI3NDU0MTllMGE3OTJlZmEwOTc1NzYzYTY4M2Q=', //process.env.DGRAPGH_API_KEY,
    },
  };
});
